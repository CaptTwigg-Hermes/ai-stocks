...
## Summary
- 2825 nodes · 6291 edges · 219 communities (199 shown, 20 thin omitted)
...
## Communities (219 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (10): FakeReadinessPort, NasdaqPostTradeClient, MarketReferenceAcquirer, IReadinessPort, OperationsHealth, CancellationToken, FirdsPlan, HttpContent (+2 more)
...
Cohesion: 0.15
Nodes (16): FakeMarket, Quote, AgentContext, Decision, State for exactly one competitor; callers must create one context per agent., _iso(), _portfolio_json(), Production-shaped scheduler → Hermes → paper-trading worker runtime. (+8 more)
...
Cohesion: 0.08
Nodes (30): AgentDefinition, IPaperTradingCommands, CollectorHealth, OperationsException, PostgresConfiguration, RuntimeConfigurationException, TestData, Account (+22 more)
...
Cohesion: 0.08
Nodes (21): FakeProcess, AccessOptions, AuthenticationFailureException, BoundedJwksFetcher, CloudflareAccessHandler, CloudflareAccessValidator, IAccessAssertionValidator, IJwksFetcher (+13 more)
...
Cohesion: 0.24
Nodes (14): bootstrap(), BootstrapError, _is_complete(), main(), One-time, idempotent initialization of the immutable contest state., Base, Agent, AgentRun (+6 more)
...
Cohesion: 0.23
Nodes (23): AgentOrchestrator, Durably claim fixed-model windows and retain one immutable record per attempt., HermesRunner, ProcessCapture, Run a stateless Hermes/Copilot turn; this class never mutates a portfolio., build_run_windows(), ContextProvider, DecisionHandler (+15 more)
...
Cohesion: 0.35
Nodes (15): MarketProvider, CorporateAction, Fill, FinalRanking, Order, OrderLifecycleEvent, OrderRejection, Evidence (+7 more)
...
- **Why does `TradingSession` connect `Community 54` to `Community 98`, `Community 131`, `Community 68`, `Community 3`, `Community 134`, `Community 39`, `Community 73`, `Community 78`, `Community 176`, `Community 18`, `Community 20`, `Community 25`?**
